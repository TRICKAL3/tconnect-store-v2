-- Create all database tables for TConnect
...
-- Create unique index on PaymentSubmission orderId
CREATE UNIQUE INDEX IF NOT EXISTS "PaymentSubmission_orderId_key" ON "PaymentSubmission"("orderId");
